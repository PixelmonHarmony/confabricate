...
//
//        // Register commands
//        CommandRegistrationCallback.EVENT.register((dispatcher, dedicated, registry) -> {
...
//        private Component message = Component.literal("\"§eto increase it's level by 1.\"");
...
//        private Component denyMessage = MutableComponent.create(new LiteralContents("You cannot do that!")).withStyle(s -> s.withColor(TextColor.fromRgb(0xFF0000)));
